...
const staffMembers: StaffMember[] = [
  {
    ...
    name: "Alex Johnson",
    role: "Owner",
    image: "https://ui-avatars.com/api/?name=Alex+Johnson&background=4a5568&color=fff&size=100",
  ...
  },
  {
    ...
    name: "Sarah Miller",
    role: "Co-Owner",
    image: "https://ui-avatars.com/api/?name=Sarah+Miller&background=4a5568&color=fff&size=100",
  ...
  },
  {
    ...
    name: "Michael Chen",
    role: "Administrator",
    image: "https://ui-avatars.com/api/?name=Michael+Chen&background=4a5568&color=fff&size=100",
  ...
  },
  {
    ...
    name: "Emily Davis",
    role: "Moderator",
    image: "https://ui-avatars.com/api/?name=Emily+Davis&background=4a5568&color=fff&size=100",
  ...
  },
  {
    ...
    name: "David Wilson",
    role: "Moderator",
    image: "https://ui-avatars.com/api/?name=David+Wilson&background=4a5568&color=fff&size=100",
  ...
  },
  {
    ...
    image: "https://ui-avatars.com/api/?name=Jessica+Brown&background=4a5568&color=fff&size=100",
...
const Staff = () => {
  ...
  return (
    <div>
      <h1 className="mb-4 text-2xl font-bold text-foreground">Staff Members</h1>
        ...
        {staffMembers.map((member) => (
          <div
            ...
            className={`cursor-pointer border border-border bg-card p-4 ${
              selectedMember?.id === member.id ? "border-primary" : "hover:bg-muted"
            }`}
          >
            <img
              src={member.image}
      ...
      {selectedMember && (
        <div className="mt-6 border border-border bg-card p-4">
          ...
          <p className="text-foreground">{selectedMember.description}</p>
        </div>
      )}
    </div>
  );
